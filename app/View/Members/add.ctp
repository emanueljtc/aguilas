...
<div id="general">
   ...
   <div class="form-horizontal">
			<?php echo $this->Form->create('Member', array('type'=>'file', 'novalidate'=>'novalidate' )); ?>
	...
	<div class="btn-group btn-group-justified">
					...
					<?php echo $this->Html->link(__('Lista Miembros'), array('action' => 'index'), array('class' => 'btn btn-info')); ?>
					<?php echo $this->Html->link(__('Lista Bautismos'), array('controller' => 'baptisms', 'action' => 'index'), array('class' => 'btn btn-danger')); ?> 
					<?php echo $this->Html->link(__('Nuevo Bautizado'), array('controller' => 'baptisms', 'action' => 'add'), array('class' => 'btn btn-primary')); ?> 
			</div>
</div>